...
void check( const mcnla::matrix::DenseMatrixColMajor<ScalarType> &matrix_a,
...
int main( int argc, char **argv ) {
  ...
  // ====================================================================================================================== //
  // Initialize driver
  mcnla::matrix::DenseMatrixColMajor<ScalarType> matrix_a(m, n), matrix_u_true;
...
void check_u(
  ...
  mcnla::matrix::DenseMatrixColMajor<ScalarType> matrix_u2(matrix_u.ncol(), matrix_u.ncol());
...
///
void check(
    const mcnla::matrix::DenseMatrixColMajor<ScalarType> &matrix_a,
    const mcnla::matrix::DenseMatrixColMajor<ScalarType> &matrix_u,
    const mcnla::matrix::DenseMatrixColMajor<ScalarType> &matrix_vt,
    const mcnla::matrix::DenseVector<ScalarType>         &vector_s,
          ScalarType &frerr
