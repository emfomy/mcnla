...
//     const index_t pitch
// ) noexcept
//   : CooMatrix(sizes.first, sizes.second, pitch) {}
...
// ) noexcept
//   : MatrixBaseType(nrow, ncol),
//     CooBaseType(pitch * size2_, value),
//     pitch_(pitch) {
//   assert(pitch_ >= size1_);
//   assert(pitch_ > 0);
// }
...
//   MatrixBaseType::operator=(other); CooBaseType::operator=(other); pitch_ = other.pitch_;
//   return *this;
// }
...
// ///
// template <typename _Scalar, Layout _layout>
// index_t CooMatrix<_Scalar, _layout>::getPitch() const noexcept { return pitch_; }

// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// /// @brief  Determines if the dimensions is equal to the sizes.
// ///
// template <typename _Scalar, Layout _layout>
// bool CooMatrix<_Scalar, _layout>::isShrunk() const noexcept {
...
// ///
// template <typename _Scalar, Layout _layout>
// const _Scalar& CooMatrix<_Scalar, _layout>::getElem(
//     const index_t rowidx,
//     const index_t colidx
// ) const noexcept {
//   assert(rowidx >= 0 && rowidx < nrow_);
...
// ///
// template <typename _Scalar, Layout _layout>
// const _Scalar& CooMatrix<_Scalar, _layout>::operator()(
//     const index_t rowidx,
//     const index_t colidx
