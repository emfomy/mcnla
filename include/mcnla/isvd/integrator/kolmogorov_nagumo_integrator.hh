...
#include <mcnla/core/la.hpp>
  ...
  #define MCNLA_TMP1 Integrator<KolmogorovNagumoIntegratorTag, _Val>
#else  // DOXYGEN_SHOULD_SKIP_THIS
  #define MCNLA_TMP0 KolmogorovNagumoIntegrator
  #define MCNLA_TMP1 KolmogorovNagumoIntegrator
