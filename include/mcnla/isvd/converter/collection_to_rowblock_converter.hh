...
#endif  // DOXYGEN_SHOULD_SKIP_THIS
  : public StageWrapper<CollectionToRowBlockConverter<_Val>, _Val> {

  friend StageWrapper<CollectionToRowBlockConverter<_Val>, _Val>;

 private:

  using BaseType = StageWrapper<CollectionToRowBlockConverter<_Val>, _Val>;
...
//  using _Val = _Val;
 ...
 protected:
  ...
  // Converts data
  void runImpl( DenseMatrixCollection201<_Val> &collection_q, DenseMatrixCollection201<_Val> &collection_qj ) noexcept;
