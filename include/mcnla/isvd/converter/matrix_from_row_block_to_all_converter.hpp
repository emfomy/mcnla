...
#ifndef MCNLA_ISVD_CONVERTER_MATRIX_FROM_ROW_BLOCK_TO_ALL_CONVERTER_HPP_
#define MCNLA_ISVD_CONVERTER_MATRIX_FROM_ROW_BLOCK_TO_ALL_CONVERTER_HPP_

#include <mcnla/isvd/converter/matrix_from_row_block_to_all_converter.hh>
#include <mcnla/core/la.hpp>

#ifndef DOXYGEN_SHOULD_SKIP_THIS
  #define MCNLA_ALIAS Converter<MatrixFromRowBlockToAllConverterTag, _Val>
#else  // DOXYGEN_SHOULD_SKIP_THIS
  #define MCNLA_ALIAS MatrixFromRowBlockToAllConverter<_Val>
...
#endif  // MCNLA_ISVD_CONVERTER_MATRIX_FROM_ROW_BLOCK_TO_ALL_CONVERTER_HPP_
