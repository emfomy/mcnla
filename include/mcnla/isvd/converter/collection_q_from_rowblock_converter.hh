...
/// The tag of converter that converts collection Q from row-block version.
///
...
class Converter<CollectionQFromRowBlockConverterTag, _Val>
 ...
 protected:
  ...
  // Converts data
  void runImpl( DenseMatrixCollection120<ValType> &collection_qj, DenseMatrixCollection120<ValType> &collection_q ) noexcept;
