////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file    include/mcnla/core/la/raw/spblas/diamm.hpp
/// @brief   The Sparse BLAS DIAMM.
///
/// @author  Mu Yang <<emfomy@gmail.com>>
///

#ifndef MCNLA_CORE_LA_RAW_SPBLAS_DIAMM_HPP_
#define MCNLA_CORE_LA_RAW_SPBLAS_DIAMM_HPP_
...
extern void mkl_sdiamm_( const FORTRAN_CHAR1 transa, const FORTRAN_INT m, const FORTRAN_INT n, const FORTRAN_INT k,
                         const FORTRAN_REAL4 alpha, const FORTRAN_CHAR1 matdescra, const FORTRAN_REAL4 val,
                         const FORTRAN_INT lval, const FORTRAN_INT idiag, const FORTRAN_INT ndiag, const FORTRAN_REAL4 b,
                         const FORTRAN_INT ldb, const FORTRAN_REAL4 beta, FORTRAN_REAL4 c, const FORTRAN_INT ldc );
extern void mkl_ddiamm_( const FORTRAN_CHAR1 transa, const FORTRAN_INT m, const FORTRAN_INT n, const FORTRAN_INT k,
                         const FORTRAN_REAL8 alpha, const FORTRAN_CHAR1 matdescra, const FORTRAN_REAL8 val,
                         const FORTRAN_INT lval, const FORTRAN_INT idiag, const FORTRAN_INT ndiag, const FORTRAN_REAL8 b,
                         const FORTRAN_INT ldb, const FORTRAN_REAL8 beta, FORTRAN_REAL8 c, const FORTRAN_INT ldc );
extern void mkl_cdiamm_( const FORTRAN_CHAR1 transa, const FORTRAN_INT m, const FORTRAN_INT n, const FORTRAN_INT k,
                         const FORTRAN_COMP4 alpha, const FORTRAN_CHAR1 matdescra, const FORTRAN_COMP4 val,
                         const FORTRAN_INT lval, const FORTRAN_INT idiag, const FORTRAN_INT ndiag, const FORTRAN_COMP4 b,
                         const FORTRAN_INT ldb, const FORTRAN_COMP4 beta, FORTRAN_COMP4 c, const FORTRAN_INT ldc );
extern void mkl_zdiamm_( const FORTRAN_CHAR1 transa, const FORTRAN_INT m, const FORTRAN_INT n, const FORTRAN_INT k,
                         const FORTRAN_COMP8 alpha, const FORTRAN_CHAR1 matdescra, const FORTRAN_COMP8 val,
                         const FORTRAN_INT lval, const FORTRAN_INT idiag, const FORTRAN_INT ndiag, const FORTRAN_COMP8 b,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief  Computes matrix-matrix product of a sparse matrix stored in the diagonal format.
///
//@{
static inline void diamm(
...
) noexcept { mkl_sdiamm_(&transa, &m, &n, &k, &alpha, matdescra, val, &lval, idiag, &ndiag, b, &ldb, &beta, c, &ldc); }
static inline void diamm(
...
) noexcept { mkl_ddiamm_(&transa, &m, &n, &k, &alpha, matdescra, val, &lval, idiag, &ndiag, b, &ldb, &beta, c, &ldc); }
static inline void diamm(
...
) noexcept { mkl_cdiamm_(&transa, &m, &n, &k, &alpha, matdescra, val, &lval, idiag, &ndiag, b, &ldb, &beta, c, &ldc); }
static inline void diamm(
    const char transa, const index_t m, const index_t n, const index_t k,
...
) noexcept { mkl_zdiamm_(&transa, &m, &n, &k, &alpha, matdescra, val, &lval, idiag, &ndiag, b, &ldb, &beta, c, &ldc); }
//@}
...
#endif  // MCNLA_CORE_LA_RAW_SPBLAS_DIAMM_HPP_
