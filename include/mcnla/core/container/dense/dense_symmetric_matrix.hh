////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file    include/mcnla/core/container/dense/dense_symmetric_matrix.hh
/// @brief   The definition of dense symmetric matrix class.
///
/// @author  Mu Yang <<emfomy@gmail.com>>
///

#ifndef MCNLA_CORE_CONTAINER_DENSE_DENSE_SYMMETRIC_MATRIX_HH_
#define MCNLA_CORE_CONTAINER_DENSE_DENSE_SYMMETRIC_MATRIX_HH_
...
struct Traits<container::DenseSymmetricMatrix<_Scalar, _trans, _uplo>> {
  ...
  using RealType    = container::DenseSymmetricMatrix<RealScalarT<_Scalar>, _trans, _uplo>;
  using ComplexType = container::DenseSymmetricMatrix<ComplexScalarT<_Scalar>, _trans, _uplo>;

  using VectorType  = container::DenseVector<_Scalar>;
  using MatrixType  = container::DenseSymmetricMatrix<_Scalar, _trans, _uplo>;
};
...
#endif  // MCNLA_CORE_CONTAINER_DENSE_DENSE_SYMMETRIC_MATRIX_HH_
