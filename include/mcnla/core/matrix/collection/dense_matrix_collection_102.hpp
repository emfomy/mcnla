...
///
template <class _Core, typename _Val>
GeMatT<_Core, DenseTag, _Val, Trans::TRANS>& DenseMatrixCollection102Base<_Core, _Val>::data() noexcept {
  return data_;
}
...
///
template <class _Core, typename _Val>
const GeMatT<_Core, DenseTag, _Val, Trans::TRANS>& DenseMatrixCollection102Base<_Core, _Val>::data() const noexcept {
  return data_;
}
...
///
template <class _Core, typename _Val>
GeMatT<_Core, DenseTag, _Val, Trans::TRANS>& DenseMatrixCollection102Base<_Core, _Val>::unfold() noexcept {
  return data_;
}
...
///
template <class _Core, typename _Val>
const GeMatT<_Core, DenseTag, _Val, Trans::TRANS>& DenseMatrixCollection102Base<_Core, _Val>::unfold() const noexcept {
  return data_;
}
...
///
template <class _Core, typename _Val>
GeMatT<_Core, DenseTag, _Val, Trans::TRANS> DenseMatrixCollection102Base<_Core, _Val>::getImpl(
    const index_t idx
) noexcept {
...
///
template <class _Core, typename _Val>
const GeMatT<_Core, DenseTag, _Val, Trans::TRANS> DenseMatrixCollection102Base<_Core, _Val>::getImpl(
    const index_t idx
) const noexcept {
  mcnla_assert_gelt(idx, 0, this->nmat());
  return data_({idx*mrow_, idx*mrow_ + nrow_}, ""_);
