...
/// @see  Array, ArrayGpu
///
template <class _Core, typename _Val> class ArrS;
...
///
template <class _Core, class _Storage, typename _Val> class GeVecS;
...
///
template <class _Core, class _Storage, typename _Val, Trans _trans> class GeMatS;
...
///
template <class _Core, class _Storage, typename _Val, Trans _trans, Uplo _uplo> class SyMatS;
...
///
template <class _Core, class _Storage, typename _Val, Trans _trans, Uplo _uplo> class TrMatS;
...
///
template <class _Core, class _Storage, typename _Val> class DiMatS;
