...
#include <mcnla/core/matrix/coo/coo_data.ipp>
#include <mcnla/core/matrix/coo/coo_tuple.hpp>
#include <mcnla/core/matrix/coo/coo_tuple.ipp>

#include <mcnla/core/matrix/coo/coo_base.hpp>
#include <mcnla/core/matrix/coo/coo_base.ipp>
#include <mcnla/core/matrix/coo/coo_iterator_base.hpp>
#include <mcnla/core/matrix/coo/coo_iterator_base.ipp>

#include <mcnla/core/matrix/coo/coo_vector.hpp>
#include <mcnla/core/matrix/coo/coo_vector.ipp>
#include <mcnla/core/matrix/coo/coo_vector_iterator.hpp>
#include <mcnla/core/matrix/coo/coo_vector_iterator.ipp>

#include <mcnla/core/matrix/coo/coo_matrix.hpp>
#include <mcnla/core/matrix/coo/coo_matrix.ipp>
