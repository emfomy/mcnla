...
///
template <typename _Scalar>
DenseVectorStorage<_Scalar>::DenseVectorStorage( DenseVectorStorage &&other ) noexcept
  : size0_(other.size0_),
    stride_(other.stride_),
...
///
template <typename _Scalar>
DenseVectorStorage<_Scalar>& DenseVectorStorage<_Scalar>::operator=( const DenseVectorStorage &other ) noexcept {
  size0_  = other.size0_;
  stride_ = other.stride_;
  value_  = other.value_;
  return *this;
...
///
template <typename _Scalar>
DenseVectorStorage<_Scalar>& DenseVectorStorage<_Scalar>::operator=( DenseVectorStorage &&other ) noexcept {
...
///
template <typename _Scalar>
bool DenseVectorStorage<_Scalar>::isEmpty() const noexcept {
...
///
template <typename _Scalar>
index_t DenseVectorStorage<_Scalar>::getNelem() const noexcept {
  return size0_;
}
...
///
template <typename _Scalar>
std::tuple<index_t> DenseVectorStorage<_Scalar>::getSizes() const noexcept {
  return std::make_tuple(size0_);
}
...
///
template <typename _Scalar>
_Scalar* DenseVectorStorage<_Scalar>::getValuePtr() noexcept {
  return *(getValue());
}
...
///
template <typename _Scalar>
const _Scalar* DenseVectorStorage<_Scalar>::getValuePtr() const noexcept {
  return *(getValue());
}
...
///
template <typename _Scalar>
Array<_Scalar>& DenseVectorStorage<_Scalar>::getValue() noexcept {
  return value_;
}
...
///
template <typename _Scalar>
const Array<_Scalar>& DenseVectorStorage<_Scalar>::getValue() const noexcept {
  return value_;
}
...
_Scalar& DenseVectorStorage<_Scalar>::getElem(
  ...
  return this->getValuePtr()[getPos(idx)];
}
