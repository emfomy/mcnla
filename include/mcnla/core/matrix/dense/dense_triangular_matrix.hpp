...
///
template <typename _Val, Trans _trans, Uplo _uplo>
DenseMatrixStorage<_Val>& DenseTriangularMatrix<_Val, _trans, _uplo>::base() noexcept {
...
///
template <typename _Val, Trans _trans, Uplo _uplo>
const DenseMatrixStorage<_Val>& DenseTriangularMatrix<_Val, _trans, _uplo>::base() const noexcept {
