...
index_t CooIdx0Storage<_Idx, _Array>::idx0Capacity() const noexcept {
...
///
template <typename _Idx, template <typename> class _Array>
index_t CooIdx0Storage<_Idx, _Array>::idx0Offset() const noexcept {
  return this->offset();
}
...
///
template <typename _Idx, template <typename> class _Array>
typename CooIdx0Storage<_Idx, _Array>::IdxArrayType& CooIdx0Storage<_Idx, _Array>::idx0() noexcept {
  return this->val();
}
...
///
template <typename _Idx, template <typename> class _Array>
const typename CooIdx0Storage<_Idx, _Array>::IdxArrayType& CooIdx0Storage<_Idx, _Array>::idx0() const noexcept {
  return this->val();
}
...
///
template <typename _Idx, template <typename> class _Array>
_Idx* CooIdx0Storage<_Idx, _Array>::idx0Ptr() noexcept {
  return this->valPtr();
}
...
///
template <typename _Idx, template <typename> class _Array>
const _Idx* CooIdx0Storage<_Idx, _Array>::idx0Ptr() const noexcept {
  return this->valPtr();
}
