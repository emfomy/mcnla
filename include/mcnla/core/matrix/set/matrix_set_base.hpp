...
#ifndef MCNLA_CORE_MATRIX_SET_MATRIX_SET_HPP_
#define MCNLA_CORE_MATRIX_SET_MATRIX_SET_HPP_
...
class MatrixSet : public utility::CrtpBase<_Derived, MatrixSet<_Derived>> {
...
#endif  // MCNLA_CORE_MATRIX_SET_MATRIX_SET_HPP_
