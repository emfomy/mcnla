////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file    include/mcnla/core/matrix/set/dense_matrix_set_120.hh
/// @brief   The definition of dense matrix set with dimension order [1 2 0].
///
/// @author  Mu Yang <<emfomy@gmail.com>>
///

#ifndef MCNLA_CORE_MATRIX_SET_DENSE_MATRIX_SET_120_HH_
#define MCNLA_CORE_MATRIX_SET_DENSE_MATRIX_SET_120_HH_
...
struct Traits<matrix::DenseMatrixSet120<_Scalar>> {
  ...
  using RealType    = matrix::DenseMatrixSet120<RealScalarT<_Scalar>>;
  using ComplexType = matrix::DenseMatrixSet120<ComplexScalarT<_Scalar>>;
  using SetType     = matrix::DenseMatrixSet120<_Scalar>;
...
#endif  // MCNLA_CORE_MATRIX_SET_DENSE_MATRIX_SET_120_HH_
