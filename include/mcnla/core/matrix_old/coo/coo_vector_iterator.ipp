////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file    include/mcnla/core/matrix/coo/coo_vector_iterator.ipp
/// @brief   The implementation of COO vector iterator.
///
/// @author  Mu Yang <<emfomy@gmail.com>>
///

#ifndef MCNLA_CORE_MATRIX_COO_COO_VECTOR_ITERATOR_IPP_
#define MCNLA_CORE_MATRIX_COO_COO_VECTOR_ITERATOR_IPP_
...
std::ostream& operator<< ( std::ostream &out, const CooVectorIteratorBase<__Scalar, __Index, __Vector> &iterator ) {
  ...
  return out << "(" << std::setw(width)     << iterator.getIdx()   << ")  "
                    << std::setw(ios_width) << iterator.getValuePtr() << std::endl;
}
...
#endif  // MCNLA_CORE_MATRIX_COO_COO_VECTOR_ITERATOR_IPP_
