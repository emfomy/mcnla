...
message(STATUS "Set 'MCNLA_OMP'            to select OpenMP library.              (Require 'MCNLA_BLAS = MKL')")
message(STATUS "")
...
foreach(d ${DEFS})
  ...
  if(${d0} MATCHES "-")
    set(comflgs "${comflgs} ${d}")
  else()
    set(comflgs "${comflgs} -D${d}")
  endif()
endforeach()
...
message(STATUS "Compile flags:             ${CMAKE_CXX_FLAGS} -DNDEBUG ${comflgs}")
message(STATUS "Link flags:                ${CMAKE_CXX_FLAGS} ${lnkflgs}")
