...
#define MATRIX_Q_PATH MCNLA_DATA_PATH "/qb_wy.mtx"

TEST(RowBlockWenYinIntegratorTest, Test) {
  ...
  mcnla::isvd::RowBlockWenYinIntegrator<ValType> integrator(parameters, 256, 1e-3);
  ...
  if ( mpi_rank == mpi_root ) {
    ...
    ASSERT_EQ(integrator.iteration(), 21);
