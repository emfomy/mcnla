...
#include <mcnla/isvd_gpu/former/col_block_gramian_former_gpu.hpp>
...
TEST(ColBlockGramianFormerGpuTest, Test) {
  ...
  // Initializes former
  mcnla::isvd::ColBlockGramianFormerGpu<ValType, true> former(parameters);
  former.initialize();
