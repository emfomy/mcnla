...
#include <mcnla/isvd_gpu/former/row_block_symmetric_former_gpu.hpp>
...
TEST(RowBlockSymmetricFormerGpuTest, Test) {
  ...
  // Initializes former
  mcnla::isvd::RowBlockSymmetricFormerGpu<ValType, true> former(parameters);
  former.initialize();
