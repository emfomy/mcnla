...
#include <mcnla/isvd_gpu/former/row_block_gramian_former_gpu.hpp>
...
TEST(RowBlockGramianFormerGpuTest, Test) {
  ...
  // Initializes former
  mcnla::isvd::RowBlockGramianFormerGpu<ValType, true> former(parameters);
  former.initialize();
